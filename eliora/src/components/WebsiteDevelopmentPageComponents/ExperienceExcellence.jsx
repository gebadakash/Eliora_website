                ...
                <div className="row g-5">
                    ...
                    <div className="col-lg-6" style={{ minHeight: '250px' }}>
                        <div className="position-relative h-100">
                            <img alt="Web Development" className="position-absolute w-100 rounded wow zoomIn" data-wow-delay="0.9s" src="images/webdev2.png" style={{ marginTop: '15%', objectFit: 'contain !important', visibility: 'visible', animationDelay: '0.9s', animationName: 'zoomIn' }} />
                        </div>
                    </div>
                </div>
            </div>
