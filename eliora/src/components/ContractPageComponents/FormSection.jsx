...
const handleSubmit = async e =>{
    ...
    return (
        <div className="container-fluid bg-registration py-5 mb-5" id="call" style={{marginTop: '-100px', backgroundImage: 'url(images/c2c_bg.png)', backgroundRepeat: 'no-repeat', backgroundSize: 'cover'}}>
            <div className="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
                <div className="container py-5">
                    <div className="row g-5">
                        <div className="col-lg-6">
                            <div className="section-title position-relative pb-3 mb-5" style={{marginTop: '-40px'}}>
                                <h1 className="mb-0 text-white">ENRICH YOUR TALENT ACQUISITION STRATEGY</h1>
                            </div>
                        ...
                        <div className="col-lg-6 ">
                            <div className="rounded h-100 d-flex align-items-center p-5 wow zoomIn c1" data-wow-delay="0.9s" style={{padding: '17px !important', backgroundColor:"rgb(91, 85, 85)"}}>
                                <form onSubmit={handleSubmit}>
                                    <h1 className="mb-0 text-white text-center">Partner with Us</h1>
                                    <p></p>
                                    <div className="row g-3">
                                        ...
                                        <div className="col-12">
                                            <select className="form-select bg-light border-0" name="work" value={formData.work} onChange={handleChange} style={{height: '55px'}}>
                                        ...
                                        <div className="col-12">
                                            <textarea className="form-control bg-light border-0" rows="3" name="message" placeholder="Message" required></textarea>
                                        </div>
                                        <div className="col-12">
