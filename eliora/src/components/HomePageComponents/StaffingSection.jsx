...
const StaffingSection = () => {
  ...
  return (
    <div className={`container-fluid py-5 wow fadeInUp mt-c mt-in`} data-wow-delay="0.1s" style={{ marginTop: "-72px" }}>
      <div className="container py-5">
        ...
        <div className="row g-5">
          ...
          <div className={`col-lg-6`}>
            ...
            <NavLink to="/placement" className="btn btn-danger py-2 px-2 mt-2 wow zoomIn navlink" data-wow-delay="0.9s">Learn More</NavLink>
            <br /><br />
            <div className="position-relative pb-2 mb-2">
            ...
            <NavLink to="/contract" className="btn btn-danger py-2 px-2 mt-2 wow zoomIn navlink" data-wow-delay="0.9s">Learn More</NavLink>
          </div>
        </div>
      </div>
    </div>
