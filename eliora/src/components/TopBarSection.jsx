          ...
          <div className="row ">
            <div className="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
              <div className={`${styles.topSection} d-inline-flex align-items-center`} style={{ height: '45px' }}>
                <a href="#" className="text-white" style={{textDecoration:'none', fontWeight:"500"}}><small className="me-3 text-light tx-l"><i className="bi bi-geo-alt-fill  mt-2 me-2"></i>Trimurti Nagar,Nagpur</small></a>
